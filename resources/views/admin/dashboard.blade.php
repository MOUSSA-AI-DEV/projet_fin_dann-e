<x-app-layout>
    ...
    <div class="container-fluid py-4" style="background-color: #f8f9fa; min-height: 100vh;">
        <div class="row mb-4">
            <div class="col-12">
                <div class="p-4 rounded shadow-sm text-white" style="background: linear-gradient(90deg, #0F172A 0%, #2563EB 100%); border-left: 6px solid #1E40AF;">
                    <h2 class="fw-bolder mb-1">Tableau de Bord Administrateur</h2>
                    <p class="mb-0 text-white-50 fw-medium">Aperçu premium en Bleu & Marine des statistiques de la boutique</p>
                </div>
        ...
        <div class="row g-4 mb-5">
            <div class="col-md-4 col-sm-6">
                <div class="card h-100 shadow-sm border-0 border-top border-primary border-4 rounded-3">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card h-100 shadow-sm border-0 border-top border-info border-4 rounded-3">
                    <div class="card-body d-flex align-items-center p-4">
                        <div class="rounded-circle bg-info bg-opacity-10 text-info p-3 d-flex align-items-center justify-content-center" style="width: 60px; height: 60px;">
                        ...
                        <div class="ms-4">
                            ...
                            <h2 class="text-info mb-0 display-6 fw-bold">{{ $commandesPaidToday }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-4 mb-5">
            <div class="col-md-3">
                <div class="card shadow-sm border-0 rounded-3 h-100" style="border-left: 4px solid #1d4ed8 !important;">
                    <div class="card-body p-4">
                        <p class="text-uppercase fw-bold mb-2" style="font-size: 0.75rem; letter-spacing: 0.5px; color: #1d4ed8;">C.A. (24h)</p>
            ...
            <div class="col-md-3">
                <div class="card shadow-sm border-0 rounded-3 h-100" style="border-left: 4px solid #2563eb !important;">
                    <div class="card-body p-4">
                        <p class="text-uppercase fw-bold mb-2" style="font-size: 0.75rem; letter-spacing: 0.5px; color: #2563eb;">C.A. (7 jours)</p>
            ...
            <div class="col-md-3">
                <div class="card shadow-sm border-0 rounded-3 h-100" style="border-left: 4px solid #3b82f6 !important;">
                    <div class="card-body p-4">
                        <p class="text-uppercase fw-bold mb-2" style="font-size: 0.75rem; letter-spacing: 0.5px; color: #3b82f6;">C.A. (30 jours)</p>
            ...
            <div class="col-md-3">
                <div class="card shadow-sm border border-primary border-opacity-25 rounded-3 h-100" style="background: linear-gradient(135deg, #eff6ff 0%, #ffffff 100%);">
                    <div class="card-body p-4">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="card shadow-sm border border-dark border-opacity-25 rounded-3 overflow-hidden h-100">
                    <div class="card-header bg-primary text-white py-3 px-4 d-flex justify-content-between align-items-center border-0" style="background: linear-gradient(90deg, #1e40af 0%, #0f172a 100%);">
                        ...
                        <span class="badge bg-primary text-white rounded-pill shadow-sm px-3 py-2">{{ $countStockCritique }} pièces</span>
                    </div>
                                    ...
                                    @foreach($piecesStockCritique as $piece)
                                        <tr>
                                            ...
                                            <td class="text-end py-3 px-4 align-middle">
                                                <span class="badge bg-primary bg-opacity-10 text-primary px-2 py-1 fs-6">{{ $piece->stock }}</span>
                                            </td>
                                        </tr>
            ...
            <div class="col-lg-6">
                <div class="card shadow-sm border border-primary border-opacity-25 rounded-3 overflow-hidden h-100">
                    <div class="card-header bg-primary text-white py-3 px-4 border-0" style="background: linear-gradient(90deg, #2563eb 0%, #1e40af 100%);">
                        <h5 class="mb-0 fw-bold d-flex align-items-center fs-6">
                    ...
                    <div class="card-body p-0" style="max-height: 400px; overflow-y: auto;">
                        @if(count($topSeries) > 0)
                            <table class="table table-hover mb-0">
                                <thead style="background-color: #1e40af; position: sticky; top: 0; z-index: 1;">
                                    <tr>
                                        <th class="text-white border-bottom border-primary border-opacity-25 py-3 px-4 text-uppercase fw-bold" style="font-size: 0.75rem;">Rang</th>
                                        <th class="text-white border-bottom border-primary border-opacity-25 py-3 px-4 text-uppercase fw-bold" style="font-size: 0.75rem;">Réf / Modèle</th>
                                        <th class="text-white border-bottom border-primary border-opacity-25 py-3 px-4 text-uppercase fw-bold text-end" style="font-size: 0.75rem;">Ventes</th>
                                    </tr>
                                </thead>
